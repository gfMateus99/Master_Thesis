...
class EAMDriftModel:
    ...
    def __init__(self,
        ...
        #selectBest_ tem de ser menor que numero de modelos
    ...
    def print_report(): # TODO: w
        ...
        #self.rules = []
        #self.train_set
        #self.features_col - colunas
        #print(self.train_set["Best Model"].value_counts())
        #FEATURE IMPORTANCE - MAYBE SAO AS LINEARES COM MAIS IMPORTANCIA
