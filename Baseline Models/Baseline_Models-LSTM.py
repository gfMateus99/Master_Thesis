...
def run_lstm_model(transformer, trainTransformed, valTransformed, series, date_split, model_="LSTM", hidden_dim_=20, 
...
def get_best_model(transformer, trainTransformed, valTransformed, seriesTransformed, date_split):
    ...
    for x in tqdm(combinations):
        lstm_model, mae_cross_val, mse_cross_val = run_lstm_model(transformer,
                                                                  trainTransformed, 
                                                                  valTransformed, 
                                                                  seriesTransformed, 
